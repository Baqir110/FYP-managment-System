...
<!--  page banner -->
  ...
  <div class="col-sm-2" style="float:left;"> <a href="approveprojects.php"><button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-bell"></span> &nbsp; Approval Requests (<?php
...
echo $k;
 ...
 <div class="row">
  ...
  <div class="col-sm-8 text-center">
   <h2 class="page-banner-heading  text-center">Supervisor Panel:  </h2><p> All Projects:</p>
   </div>
   <div class="col-sm-2"></div>
</div>
  </section> 
