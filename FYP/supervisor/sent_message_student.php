                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class=""><a href="student_message.php" style =" border-radius:10px;"><i class="icon-envelope-alt"></i>inbox</a></li>
										<li class="active"><a href="sent_message_student.php " style = "border-radius : 10px;" ><i class="icon-envelope-alt "></i>Sent messages</a></li>
										</ul>
