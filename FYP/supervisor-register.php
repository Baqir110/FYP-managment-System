...
if(isset($_POST['fname'])){
	...
	if($_POST['intarea']=="" && $usertype != 'Supervisor'){
...
<!--  page banner -->
  <section id="page-banner" class="page-banner-main-block ran" style="background-image: url('images/bg/page-banner.jpg')"> 
    <h1 class="page-banner-heading text-center">Supervisor Registration</h1>
  </section> 
<!--  end page banner  -->

<div class="row ">
<div class="col-sm-3"></div>
<form method="post" enctype="multipart/form-data" action="supervisor-register.php">
<div class="col-sm-6">
...
<div class="form-group">
							<label> Register as:</label>
								...
								<select class="form-control stu2" required name="usertype">
