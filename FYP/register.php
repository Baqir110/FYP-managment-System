...
<!--  page banner -->
  <section id="page-banner" class="page-banner-main-block ran" style="background-image: url('images/bg/page-banner.jpg')"> 
    <h1 class="page-banner-heading text-center">Student Registration</h1>
  </section> 
<!--  end page banner  -->
...
<div class="form-group">
               ...
               <div class="form-group"><label>Upload your Pic: </label>
                <input  type="file" name="img"  /><p style="color:red; font-size:13px;"><?php if(isset($error)) echo $error; ?></p>
              </div>
              <div class="form-group">
