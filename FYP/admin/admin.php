...
<a href="selectuser.php"><div class="col-sm-4 text-center"  style="font-size:20px;border-right: 180px solid white;padding: 20px;background:#333333;color: white;"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp; Manage Users</div></a>
<a href="projects.php">
<div class="col-sm-4 text-center" style="font-size: 20px;padding: 20px;background:#333333;color: white;border-left: solid 180px;  " ><span class="glyphicon glyphicon-list-alt"></span> &nbsp;&nbsp;Manage Projects</div></a>
