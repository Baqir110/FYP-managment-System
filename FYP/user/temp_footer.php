       ...
       <!--   <div class="footer-news footer-widget">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-contact footer-widget">
            ...
            <p>If you want to contact us about any issue, our support available to help you 9am-5pm Monday to Saturday.</p>
            <ul class="footer-address">
              <li><span>Address:</span> Okan University</li>
              <li><span>Call:</span> <a href="tel:#">5513978329</a></li>
              <li><span>Email:</span> <a href="mailto:#">ihzindabad44@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
