...
<head>
  <title>Student Panel - FYP Management System</title>
  <meta charset="utf-8" />
...
<link rel="icon" type="image/icon" href="..\images/favicon/icon.ico"> <!-- favicon-icon -->
<!-- theme style -->
    ...
    <div class="row">
      ...
      <div class="col-sm-8">
          ...
          <div class="col-sm-3" style="float:right;">
             <a href="#" class="btn btn-default pull-right" data-toggle="modal" data-target="#request-model">Supervisor Advise</a>
          </div>
        </div>
      </div>
          ...
          <div id="cssmenu">
            ...
            <!--  <li><a href="#">Projects</a>
              ...
              <li><a href="..\contact.html">Contact Us</a></li>
               <li><a href="#">Account</a>
      <ul class="dropdown">
        <li><a href="../user/userlogin.php">My Profile</a></li>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title text-center">Supervisor Advise</h5>
          </div>
