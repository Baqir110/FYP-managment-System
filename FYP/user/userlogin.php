...
<div class="col-sm-2" ></div>
  <div class="col-sm-8">
   ...
   <img src="<?php echo $_SESSION['img'];?>" style="width:160px; border-radius:80px;"/></center>
   <center class = "bot"> <h4 class=" text-center"><?php echo $_SESSION['name']; ?></h4></center>
...
<div class="row">
	<div class="col-sm-2"></div>
<a href="addproject.php"><div class="col-sm-4 text-center"  style="font-size:20px;border-right: 180px solid white;padding: 20px;background:#333333;color: white;"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp; Add a Project</div></a>
<a href="viewprojects.php">
<div class="col-sm-4 text-center" style="font-size: 20px;padding: 20px;background:#333333;color: white;border-left: solid 180px; " ><span class="glyphicon glyphicon-list-alt"></span> &nbsp;&nbsp;View Projects</div></a>
		   </div><br>
		   <div class="row">
